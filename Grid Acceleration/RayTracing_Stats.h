...
// This class only contains static variables and static member functions 
// so there is no need to call the constructor, destructor, etc.

// It's just a wrapper for the global statistics data.

// =======================================================================
// =======================================================================

class RayTracing_Stats
...
public:
	...
	static void Initialize(int w, int h, int nx, int ny, int nz, const Vec3f & min, const Vec3f & max) 
	{
		width = w; height = h;
