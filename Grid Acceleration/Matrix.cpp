...
// ================================================
//  Implemention of Global Matrix Utility Function
// ================================================

float calcDeterminant(const float ** matrix, int degree)
{
	assert (degree > 0 && matrix != NULL);

	// TODO:
	return 0;
}

float calcDeterminant3_3(const float matrix[][3])
{
